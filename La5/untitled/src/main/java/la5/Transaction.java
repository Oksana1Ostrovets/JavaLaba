    ...
    public static class Builder {
        ...
        public Builder setTransactionId(String transactionId) {
            if (transactionId == null || transactionId.length() < MIN_TRANSACTION_ID_LENGTH || transactionId.length() > MAX_TRANSACTION_ID_LENGTH) {
                throw new IllegalArgumentException("Invalid transaction ID. Length should be between " +
        ...
        public Builder setAmount(double amount) {
            if (amount < MIN_AMOUNT) {
                throw new IllegalArgumentException("Invalid amount. Should be greater than or equal to " + MIN_AMOUNT);
            }
            this.amount = amount;
            return this;
        }
