    ...
    public static class Builder {
        ...
        public Builder setName(String name) {
            if (name == null || name.length() < MIN_NAME_LENGTH || name.length() > MAX_NAME_LENGTH) {
                errors.add("Invalid name. Length should be between " +
        ...
        public Builder setLocation(String location) {
            if (location == null || location.length() < MIN_LOCATION_LENGTH || location.length() > MAX_LOCATION_LENGTH) {
                errors.add("Invalid location. Length should be between " +
        ...
        public Bank build() {
            if (!errors.isEmpty()) {
                throw new IllegalStateException("Cannot build Bank due to validation errors: " + errors);
            }
